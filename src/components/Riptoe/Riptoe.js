...
import styles from './Riptoe.less';
...
const Riptoe = withRouter(( {history} ) => (
	<Container>
			<Row>
				<Col lg="12">
					<Col lg="12">
						<h1>Lift - Riptoe workout</h1>
			...
			<Row>
				...
				<Col lg="3">
					<Col lg="12" className="riptoe-workout-method-week text-center">
						<Col lg="12">
							<p>Riptoe method Week 1</p>
						</Col>
						<Col lg="12">
							<h1>Day 2</h1>
						</Col>
						<Col lg="12" className="text-center riptoe-start-workout" onClick={() => { history.push('/workout') }}>
							<p>Start</p>
						</Col>
					</Col>
				</Col>
